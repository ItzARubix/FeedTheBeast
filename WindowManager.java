...
public class WindowManager {
	...
	private void loop() {
		...
		// Set the clear color. Float casts are required otherwise it doesn't work for whatever reason. 
		float RGBRed = (float)198/255;
		float RGBGreen = (float)220/255;
		float RGBBlue = (float)247/255;
		glClearColor(RGBRed, RGBGreen, RGBBlue, 0.0f);
